...
ent-ClothingHeadHatWitchhatservice = шляпа сервисной ведьмы
    .desc = Стильная колдовская шляпа только для ведьмочек. Сделана из лучшей зачарованной ткани в известном космосе. Товарный знак принадлежит Ковену Звёздного Сияния. Все права защищены.
