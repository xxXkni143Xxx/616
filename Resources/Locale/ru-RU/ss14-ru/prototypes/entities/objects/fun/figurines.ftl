...
ent-ToyFigurineSpaceDragon = фигурка Яста
    .desc = Большая фигурка, изображающая известное существо из красного пространства. Изначально такие использовались в качестве опытных макетов, но в результате удачного коммерческого решения поступили в продажу.
